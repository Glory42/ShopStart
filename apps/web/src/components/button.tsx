...
export type ButtonVariant = "primary" | "invert" | "secondary" | "ghost";
...
const variants: Record<ButtonVariant, string> = {
  ...
  /** Always the inverse of the page background — light pill on dark, dark pill on light. */
  invert: "bg-ink text-canvas px-6 py-3 hover:opacity-90 active:scale-[0.98]",
  secondary:
    "border border-hairline text-ink px-6 py-3 hover:border-ink bg-paper-2 active:scale-[0.98]",
